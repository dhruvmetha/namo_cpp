...
PANELS = {"auc_bfix.json": None, "auc_bng.json": None, "auc_arj.json": None, "auc_aj2.json": None, "auc_aj3.json": None, "auc_xbrp.json": None, "auc_round2_early.json": None, "auc_round2.json": None, "auc_rpe.json": None, "auc_r3.json": None}
...
ORDER = [k for k in ("Bfix", "BfixNR", "ANR", "BNG", "ARJ", "AJ2", "AJ2NR", "XB", "RP", "MM", "EG", "EGMM", "RPB", "RPE", "RPL", "RPG", "RPEG")
