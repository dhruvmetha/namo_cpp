...
JOBS = [("m2b  1-push opener @H=1", "/scratch/dm1487/h5/v4_hq_m2b_scorer/data.h5", 1, 0.999),
        ("h2   setup           @H=2", "/scratch/dm1487/h5/v4_hq_h2_scorer/data.h5", 2, 0.5),
        ("postpush finish      @H=1", "/scratch/dm1487/h5/v4_hq_postpush_v2/shard_0.h5", 1, 0.999)]
...
def main():
    ...
    json.dump(out, open("/scratch/dm1487/eval/train_diag.json", "w"), indent=1)
