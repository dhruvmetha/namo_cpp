...
OUT=${AMAREL_ROOT}/aquaman0/eval_v4
SUB=ilab2.cs.rutgers.edu

# model -> "jobid:ckptdir jobid:ckptdir ..."   (first COMPLETED wins)
declare -A CAND=(
  [AJ4_s1]="203978:AJ4_s1"
  [AJ4NR_s1]="204241:AJ4NR_s1"
  [AJ4_s2]="203971:AJ4_s2"
  [AJ4NR_s2]="204181:AJ4NR_s2"
  [AJ4_s3]="203979:AJ4_s3"
  [AJ4NR_s3]="204136:AJ4NR_s3"
)
ALL="AJ4_s1 AJ4_s2 AJ4_s3 AJ4NR_s1 AJ4NR_s2 AJ4NR_s3"
...
# already-finished model -- on 2026-08-08 that submitted AJ4_s1 twice, two arrays writing the same
...
ssh amarel "for i in \$(seq 1 120); do q=\$(squeue -u dm1487 -h -t R,PD -r -n aq_AJ4_s1,aq_AJ4_s2,aq_AJ4_s3,aq_AJ4NR_s1,aq_AJ4NR_s2,aq_AJ4NR_s3 | wc -l); \
  [ \"\$q\" -eq 0 ] && break; sleep 45; done; echo drained \$(date)"

ssh amarel "n=\$(ls $OUT/{AJ4_s1,AJ4_s2,AJ4_s3,AJ4NR_s1,AJ4NR_s2,AJ4NR_s3}/{1push_hmax2,2push}/*.json 2>/dev/null | wc -l); echo \"eval shards=\$n\""
rsync -a --include='*/' --include='shard_*.jsonl' --include='shard_*.json' --exclude='*' \
  "amarel:$OUT/" "$R0/eval_v4/"
echo "ARJUNA V4 EVAL PULLED $(date)"
