...
OUT=${AMAREL_ROOT}/aquaman0/eval_v3
SUB=ilab2.cs.rutgers.edu

# model -> "jobid:ckptdir jobid:ckptdir ..."   (first COMPLETED wins)
declare -A CAND=(
  [AJ3_s1]="203928:AJ3_s1"
  [AJ3NR_s1]="203929:AJ3NR_s1"
  [AJ3_s2]="203930:AJ3_s2"
  [AJ3NR_s2]="203994:AJ3NR_s2"
  [AJ3_s3]="203968:AJ3_s3"
  [AJ3NR_s3]="203969:AJ3NR_s3"
)
ALL="AJ3_s1 AJ3_s2 AJ3_s3 AJ3NR_s1 AJ3NR_s2 AJ3NR_s3"
...
# already-finished model -- on 2026-08-08 that submitted AJ3_s1 twice, two arrays writing the same
...
ssh amarel "for i in \$(seq 1 120); do q=\$(squeue -u dm1487 -h -t R,PD -r | wc -l); \
  [ \"\$q\" -eq 0 ] && break; sleep 45; done; echo drained \$(date)"

ssh amarel "n=\$(ls $OUT/{AJ3_s1,AJ3_s2,AJ3_s3,AJ3NR_s1,AJ3NR_s2,AJ3NR_s3}/{1push_hmax2,2push}/*.json 2>/dev/null | wc -l); echo \"eval shards=\$n/432\""
rsync -a --include='*/' --include='shard_*.jsonl' --include='shard_*.json' --exclude='*' \
  "amarel:$OUT/" "$R0/eval_v3/"
echo "ARJUNA V3 EVAL PULLED $(date)"
