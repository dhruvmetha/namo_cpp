...
CKPT = Path("/common/users/dm1487/scratch_namo/aquaman/round0/models/B_s1/checkpoints/epoch011-val_loss1.7068.ckpt")
RAW = Path("/common/users/dm1487/scratch_namo/aquaman/round0/raw")
WORK = Path("/common/users/dm1487/scratch_namo/aquaman/round0/v2_b1")
OUT = Path("/common/users/dm1487/scratch_namo/aquaman/round1/old_refreshed.h5")
