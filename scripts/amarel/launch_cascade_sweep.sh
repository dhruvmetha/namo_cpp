...
#   Hz-v2   -> $NAMO_SCRATCH/eval/bf900_qfull_v2_v4hq_s1        (@2 24.2, @900 94.9)
#   NoHz-v2 -> $NAMO_SCRATCH/eval/bf900_qfull_nohz_v2_v4hq_s1   (@2 32.6, @900 91.6)
...
MAN="$NAMO_MANIFESTS/test_pure2_fromkey.txt"
HZ="$NAMO_SCRATCH/sage_outputs/scorer/qfull_v2_v4hq_s1/namo-classifier/10whb62b/checkpoints/epoch008-val_loss0.6728.ckpt"
NOHZ="$NAMO_SCRATCH/sage_outputs/scorer/qfull_nohz_v2_v4hq_s1/namo-classifier/4w1hovo4/checkpoints/epoch007-val_loss0.7041.ckpt"
...
submit () {  # $1=tag(hz|nohz) $2=ckpt $3=dive_bonus
  ...
  local out="$NAMO_SCRATCH/eval/${base}_dive${db}"
