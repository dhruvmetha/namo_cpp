...
| 08-13 | unreachable rule on the **old corpus** (AJ2U) | is it a general training fix or hybrid-specific? | ❌ **does not transfer** — solve rates flat; only sims-to-solve improves (110→77). Rule belongs with child-heavy corpora | [crossboard](log/EXP-2026-08-09-crossboard-ranking.md) |
