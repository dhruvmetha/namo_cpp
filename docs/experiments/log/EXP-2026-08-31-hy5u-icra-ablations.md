...
At commit `1b164795`, the nine selected best-validation checkpoints were checksum-verified after transfer to Amarel. Bundled target-box smokes are no-family `61227032`, regression-only `61227033`, and independent-contacts `61227034`; each covers seven manifest entries from each horizon with 14 simultaneous evaluator processes. Full arrays are no-family `61227079`–`61227081`, regression-only `61227082`–`61227084`, and independent-contacts `61227085`–`61227087`. Every 36-task full array has a strict `afterok` dependency on its family smoke, a two-hour task limit sized after the smoke's 900-simulation tail exceeded eight minutes, and writes only to the new `/scratch/dm1487/eval/hy5u_ablations_20260904/full/` root.
