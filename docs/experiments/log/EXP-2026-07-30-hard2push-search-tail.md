...
The calibrated 10,000-call worst-case estimate is 53m37s per episode. Amarel job `59592040` pilots two of the 12 tail episodes at the full 10,000-call cap with a 2h wall limit; if both reproduce unsolved-through-900 and complete cleanly, run the other ten with the same configuration.
