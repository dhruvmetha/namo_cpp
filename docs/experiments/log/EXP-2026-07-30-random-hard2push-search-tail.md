...
The user then removed the one remaining shared queue failure after the exhaustive GT proved its unique successful chain. Final registry-aware filtering leaves 137 hard episodes: learned finishes 137/137 = 100%; random seeds finish 135/137, 136/137, and 137/137 = 99.3±0.7%. Learned reaches 50/75/90/95/99/100% at 20/100/336/1,071/2,507/3,831 calls; random mean reaches 50/75/90/95/99% at 330/871/1,728/3,456/8,286 calls and never reaches 100%. The final speed factors are 16.5×/8.7×/5.1×/3.2×/3.3× at 50/75/90/95/99%. Solved-only averages remain 171.1 calls for learned versus 733.3±52.9 for random because the removed episode was unsolved by every arm. This paragraph supersedes the 138-episode paragraph above.
