...
tags:
  ...
  - archive
archived: 2026-07-16
superseded_by: ../RESULTS.md (Marvel DAgger curriculum framework)
---
# Results — ARCHIVE: horizon-Q / NoHz single-ranker line (pre-DAgger-curriculum)

Archived 2026-07-16. The pre-curriculum results compilation: the horizon-conditioned (Hz-v3) and no-horizon (NoHz-v3) single-ranker line, the RL-only self-imitation probe, the horizon-role probe, and the seeded prior-work ledger.
Superseded as the LIVE doc by the DAgger curriculum framework in [../RESULTS.md](../RESULTS.md); kept here verbatim so nothing is lost. Cards and numbers referenced below remain valid.
