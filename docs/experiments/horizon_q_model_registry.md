...
- **HORIZON-ROLE PROBE [2026-07-09, arrakis, s1, `…/eval/horizon_probe/`]:** reproduces the above (NoHz pure2 reactive 40.8 / bf 38.1; Hz reactive 45.3 / bf 35.9). NEW — ran on the **1-push set** too: horizon input is a *working route knob* (NoHz H=2≡H=1 byte-identical = control; Hz H=2 demotes opener→setup, −7.9pp react@1) but net-neutral on solve-rate (react@2 Hz-H2 90.9 ≈ NoHz 89.7); tax on easy / +4pp on hard. See [[EXP-2026-07-09-horizon-role-probe]] + RESULTS §7.
