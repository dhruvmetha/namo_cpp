...
- **beast-2 armA (uniform):** `round2/models/beast2_armA/checkpoints/epoch011-val_loss0.5267.ckpt` — 2p solve 96.7 / 81.6 avg sims / 71.4@30 (best-ever 2p search axis); 1p hard@1 43.1. train_h5: `round2/h5/beast2_all.h5`.
- **beast-2 armB (balanced 50/50):** `round2/models/beast2_armB/checkpoints/epoch004-val_loss0.5799.ckpt` — 1p hard@1 **49.5** (best of line); 2p 96.3/94.5/67.4. train_h5: `round2/h5/beast2_all.h5`.
