...
- **Location:** `$NAMO_DATASETS/namo_testset_v1/` (its `README.md` is the full datasheet).
...
- **Output:** `$NAMO_SCRATCH/outputs/v4_hq_h1/` (SLURM job 55944720, array 0-59, launched 2026-06-11) (CS only).
- **Scenes:** `$NAMO_MANIFESTS/v3_feb_top250k.txt` (250 000 v3 feb_car envs). *(aug9_car can be added for composition parity with v3_scorer_e4; feb-only for the first pass.)*
