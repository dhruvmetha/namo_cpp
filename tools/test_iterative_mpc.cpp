...
private:
    ...
    IncrementalWavefrontPlanner& wavefront_planner_;
...
public:
    IterativeMPCExecutor(NAMOEnvironment& env, GreedyPlanner& planner, MPCExecutor& executor, NAMOPushController& controller, IncrementalWavefrontPlanner& wavefront_planner)
...
int main() {
    try {
        ...
        try {
            ...
            // std::cout << "✓ IncrementalWavefrontPlanner created successfully" << std::endl;
